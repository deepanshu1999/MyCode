...
public class CitationSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar)findViewById(R.id.cittoolbar);
        ...
        mTitle.setText("Citation Search");
...
//TODO ::::PUT CLASS NAME HERE
        ...
        protected void onPostExecute(String s) {
            progressDialog.dismiss();
            Intent i=new Intent(CitationSearch.this,Viewer.class);
            i.putExtra("CALLER",CitationSearch.CITATION);
            Res=s;
            if(s.length()==2){
                Toast.makeText(CitationSearch.this,"No Result",Toast.LENGTH_SHORT).show();
